...
async function aaa () {
    ...
    let start = 'q # {{# comment}} {{unless bbb}}bbb is missing.(( = bbb.ccc ddd.eee.fff( ttt.kkk.mmm zzz.$$$) )){{end}}{{ if tester}} tester is {{aaa}} true {{ else }} tester if false {{end}} {{-q-w-e-}}# asset';
