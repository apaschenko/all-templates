    ...
    switch (ast.type) {
        ...
        case 'function':
            ...
            for (let argAst of ast.args) {
                const argValue = await processor(argAst, processorData, processorData.data, false, timeout);
                arguments.push(argValue);
            }
            result = await utils.asyncCall(point, arguments, processorData, timeout);
            break;
