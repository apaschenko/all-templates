/**
 * Lib "all-templates"
 * Starter: a class for the processing of the start layer.
 *
...
class Starter {
    ...
    async start() {
        ...
        const Processor = new Processor(this.renderData);
        return await Processor.processBlock(this.controlTree.getRootBlock());
    }
