...
class Parser {
                ...
                case STATUS.TEXT:
                    if (symbol === placeholder.open[this.buffer.length]) {
                        if (this.buffer.length === openPhMaxPosition) { // new placeholder started
                            this.phBoundaries =
                                new PhBoundaries(posInLayer - openPhMaxPosition, this.renderData, this.layer);
                            ...
                            this.levels = [];
                            this.phStartedAt = posInLayer - openPhMaxPosition;
    ...
    checkToPhErrors() {
        if (this.error) {
            this.error.placeholder = this.phBoundaries.getPlaceholder();
