...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c28 = function(chars) { return { type: "regular", value: chars.join("") }; },
      peg$c29 = function(lex) {return !keywords.includes(lex.toLowerCase())},
      peg$c30 = function(lex) {return {type: 'regular', value: lex}},
      peg$c31 = "@",
      peg$c32 = peg$literalExpectation("@", false),
      peg$c33 = function(val) {return {type: 'local_var', value: val.value}},
      peg$c34 = function(locVar, tail) {return tail},
      peg$c35 = function(locVar, tail) {
                      const arr=[locVar];
                      if (tail) {
                        for (let i of tail) {
                            arr.push(i)
      ...
      peg$c37 = function(left, operator, right) { return {type: 'expression_get', left, right, operator} },
      peg$c38 = function(operator, right) { return {type: 'expression_get', right, operator} },
      peg$c39 = function(left, operator, right) { return {type: 'expression_set', left, right, operator} },
      peg$c40 = function(operator, right) { return {type: 'expression_set', right, operator} },
      peg$c41 = function(left, operator) { return {type: 'expression_set', left, operator} },
      ...
      peg$c76 = function(op) {return 'prefix' + op},
      peg$c77 = "++",
      peg$c78 = peg$literalExpectation("++", false),
      peg$c79 = "--",
      peg$c80 = peg$literalExpectation("--", false),
      peg$c81 = function(op) {return 'postfix' + op},
      peg$c82 = "&&",
      peg$c83 = peg$literalExpectation("&&", false),
      peg$c84 = function() {return '&&'},
      peg$c85 = "and",
      peg$c86 = peg$literalExpectation("AND", true),
      peg$c87 = "||",
      ...
      peg$c105 = "e",
      peg$c106 = peg$literalExpectation("e", true),
      peg$c107 = /^[+\-]/,
      peg$c108 = peg$classExpectation(["+", "-"], false, false),
      peg$c109 = function(whole_part, fraction, exponent) {
                	return {
                	    type: 'literal',
                	    value: (fraction || exponent) ? parseFloat(text()) : parseInt(text(), 10)
                  }
              },
      peg$c110 = function(open, truePath, falsePath, end) {
      		    let txt = [open.txt];
      		    if (falsePath) {
      ...
      peg$c111 = function(value) { return {value, txt: text()} },
      peg$c112 = function(open, falsePath, truePath, end) {
                  let txt = [open.txt];
                  if (truePath) {
      ...
      peg$c113 = function(expr) { return {type: 'tag_insert', value: expr, txt: text()} },
      peg$c114 = function(open, value, end) {
                  return {
                      type: 'tag_for', init: open.init, cond: open.cond, after: open.after, value, txt: [open.txt, end]
                  }
              },
      peg$c115 = function(init, cond, after) { return {init, cond, after, txt: text()} },
      peg$c116 = function(variable, source) { return {variable, source, txt: text()} },
      peg$c117 = function(open, value) { return text(); },
      peg$c118 = function(open, value, empty, emptyLayer) { return text(); },
      peg$c119 = function(open, value, empty, emptyLayer, delimiter, delimiterLayer, end) {
          	    return buildEachTag(open, value, empty, emptyLayer, delimiter, delimiterLayer, end);
              },
      peg$c120 = function(open, value, delimiter, delimiterLayer) { return text(); },
      peg$c121 = function(open, value, delimiter, delimiterLayer, empty, emptyLayer, end) {
          	    return buildEachTag(open, value, empty, emptyLayer, delimiter, delimiterLayer, end);
              },
      peg$c122 = function(expr) { return {expr, txt: text()} },
      peg$c123 = function(open, layer, end) { return {type: 'tag_while', expression: open.expr, layer, txt: [open.txt, end]} },
      peg$c124 = function(open, layer, expr) { return {expr, txt: text()} },
      peg$c125 = function(open, layer, whilePart) { return {type: 'tag_do_while', expression: whilePart.expr, layer, txt: [open, whilePart.txt]} },
      peg$c126 = function(expression) { return {type: 'tag_set', expression, txt: text()} },
      peg$c127 = function() { return {type: 'tag_empty'}; },
      peg$c128 = "end",
      peg$c129 = peg$literalExpectation("END", true),
      peg$c130 = "else",
      peg$c131 = peg$literalExpectation("ELSE", true),
      peg$c132 = function(txt, layer) { return {layer, txt} },
      ...
      peg$c149 = "if",
      peg$c150 = peg$literalExpectation("IF", true),
      peg$c151 = "unless",
      peg$c152 = peg$literalExpectation("UNLESS", true),
      peg$c153 = "each",
      peg$c154 = peg$literalExpectation("EACH", true),
      peg$c155 = "of",
      peg$c156 = peg$literalExpectation("OF", true),
      peg$c157 = "with",
      peg$c158 = peg$literalExpectation("WITH", true),
      peg$c159 = "empty",
      peg$c160 = peg$literalExpectation("EMPTY", true),
      peg$c161 = "for",
      peg$c162 = peg$literalExpectation("FOR", true),
      peg$c163 = "while",
      peg$c164 = peg$literalExpectation("WHILE", true),
      peg$c165 = "do",
      peg$c166 = peg$literalExpectation("DO", true),
      peg$c167 = "set",
  ...
  function peg$parseQuotedIdPart() {
    var s0, s1, s2, s3;
    ...
    if (s1 !== peg$FAILED) {
      s2 = [];
      s3 = peg$parseQuotedIdPartCharacter();
      while (s3 !== peg$FAILED) {
        s2.push(s3);
        s3 = peg$parseQuotedIdPartCharacter();
      }
  ...
  function peg$parseQualifiedLocalVar() {
  ...
  function peg$parseAbstractId() {
    var s0;

    s0 = peg$parseQualifiedLocalVar();
    if (s0 === peg$FAILED) {
      s0 = peg$parseId();
    }
  ...
  function peg$parseQuotedIdPartCharacter() {
    var s0, s1, s2;
          ...
          if (s4 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s6 !== peg$FAILED) {
                ...
                if (s7 !== peg$FAILED) {
                  peg$savedPos = s0;
                  s1 = peg$c119(s1, s2, s3, s4, s5, s6, s7);
                  s0 = s1;
                } else {
                  peg$currPos = s0;
                  s0 = peg$FAILED;
