...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c28 = function(value) {return {type: 'pointer', value}},
      peg$c29 = function(lex) {return {type: 'integer', value: parseInt(lex.join(''), 10)}},
      peg$c30 = function(lex) {return !keywords.includes(lex.toLowerCase())},
      peg$c31 = function(lex) {return {type: 'regular', value: lex}},
      peg$c32 = function(open, truePath, falsePath, end) {
      		    let txt = [open.txt];
      		    if (falsePath) {
      ...
      peg$c33 = function(value) { return {value, txt: text()} },
      peg$c34 = function(open, falsePath, truePath, end) {
                  let txt = [open.txt];
                  if (truePath) {
      ...
      peg$c35 = function(expr) { return {type: 'tag_insert', value: expr, txt: text()} },
      peg$c36 = function(open, value, end) {
                  return {
                      type: 'tag_for', init: open.init, cond: open.cond, after: open.after, value, txt: [open.txt, end]
                  }
              },
      peg$c37 = function(init, cond, after) { return {init, cond, after, txt: text()} },
      peg$c38 = function(variable, source) { return {variable, source, txt: text()} },
      peg$c39 = function(open, value) { return text(); },
      peg$c40 = function(open, value, empty, emptyLayer) { return text(); },
      peg$c41 = function(open, value, empty, emptyLayer, delimiter, delimiterLayer, end) {
          	    return buildEachTag(open, value, empty, emptyLayer, delimiter, delimiterLayer, end);
              },
      peg$c42 = function(open, value, delimiter, delimiterLayer) { return text(); },
      peg$c43 = function(open, value, delimiter, delimiterLayer, empty, emptyLayer, end) {
          	    return buildEachTag(open, value, empty, emptyLayer, delimiter, delimiterLayer, end);
              },
      peg$c44 = function(expr) { return {expr, txt: text()} },
      peg$c45 = function(open, layer, end) { return {type: 'tag_while', expression: open.expr, layer, txt: [open.txt, end]} },
      peg$c46 = function() { return text(); },
      peg$c47 = function(open, layer, expr) { return {expr, txt: text()} },
      peg$c48 = function(open, layer, whilePart) { return {type: 'tag_do_while', expression: whilePart.expr, layer, txt: [open, whilePart.txt]} },
      peg$c49 = function(expression) { return {type: 'tag_set', expression, txt: text()} },
      peg$c50 = function() { return {type: 'tag_empty'}; },
      peg$c51 = "end",
      peg$c52 = peg$literalExpectation("END", true),
      peg$c53 = "else",
      peg$c54 = peg$literalExpectation("ELSE", true),
      peg$c55 = function(txt, layer) { return {layer, txt} },
      peg$c56 = function(expr) { return expr },
      peg$c57 = function(left, operator, right) { return {type: 'expression', left, right, operator} },
      peg$c58 = function(operator, right) { return {type: 'expression', right, operator} },
      peg$c59 = function(left, operator) { return {type: 'expression', left, operator} },
          ...
          if (s4 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              ...
              if (s6 !== peg$FAILED) {
                ...
                if (s7 !== peg$FAILED) {
                  peg$savedPos = s0;
                  s1 = peg$c43(s1, s2, s3, s4, s5, s6, s7);
                  s0 = s1;
                } else {
                  peg$currPos = s0;
                  s0 = peg$FAILED;
